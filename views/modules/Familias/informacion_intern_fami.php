...
<?php if (isset($_GET['ok'])) { ?>
    <script>
        alert("Interno guardado correctamente");
    </script>
<?php } ?>
            ...
            <div class="col-lg-9 col-xl-10">
                <div class="card shadow-sm border-0 rounded-3">
                    ...
                    <div class="card-body p-4">
                        ...
                        <form action="../../../controllers/guardar_interno.php" method="POST" class="needs-validation" novalidate>
                            <input type="hidden" name="id_fundacion" value="<?php echo $_SESSION['id_fundacion']; ?>">
                            <div class="row g-3">
                                ...
                                <div class="col-md-6">
                                    <label class="form-label fw-semibold">
                                        <i class="bi bi-calendar-check text-success me-1"></i>LUGAR DE NACIMIENTO
                                    </label>
                                    <div class="input-group">
                                        <span class="input-group-text bg-success bg-opacity-10 border-0">
                                            <i class="bi bi-calendar text-success"></i>
                                        </span>
                                        <input type="text" name="lugar_nacimiento" class="form-control" placeholder="Ingrese lugar de nacimiento">
                                    </div>
                                </div>
                                ...
                                <div class="col-md-6">
                                    ...
                                    <div class="input-group">
                                        ...
                                        <input type="text" name="num_doc" class="form-control" placeholder="Ingrese número de documento" required>
                                    </div>
