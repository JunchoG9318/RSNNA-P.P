                ...
                <div class="card shadow-sm border-0 rounded-3">
                    ...
                    <div class="card-body p-4">
                        ...
                        <form class="needs-validation"
                            action="<?php echo BASE_URL; ?>controllers/FamiliaController.php"
                            method="POST"
                            novalidate>
                            <input type="hidden" name="interno_id" value="1">
                            <div class="row g-3">
                                ...
                                <div class="col-12">
                                    ...
                                    <div class="input-group">
                                        ...
                                        <input type="text" name="direccion" class="form-control" placeholder="Ingrese dirección completa">
                                    </div>
                                </div>
                            ...
                            <div class="d-flex flex-wrap justify-content-between align-items-center mt-4 pt-3 border-top">
                                ...
                                <div class="d-flex gap-2">
                                    ...
                                    <button type="submit" name="guardar_familiar" class="btn btn-success px-4 py-2">
